            ...
            <div className='twoBigCards'>
                ...
                <a href='/#' className="firstBigPic">
                  <div className='textContainer'>
                    ...
                    <p className="subBigOne">Aenean velit felis, interdum tristique odio eget, tempor convallis felis. Phasellus et dui purus. Donec vulputate orci sed purus venenatis, a finibus eros tristique. Phasellus faucibus, ligula ac porta rutrum, nisl enim commodo tortor, vitae euismod ex nisl id est.</p>
                  </div>
                    </a>
                ...
                <a href='/#' className="secondBigPic">
                    ...
                    <p className="subBigOne">Proin odio neque, mattis eu augue eu, lacinia lacinia augue. Aliquam euismod nibh quis purus euismod bibendum. Proin eleifend ipsum at augue scelerisque, eget malesuada lacus varius. Proin pharetra quam id quam accumsan, eget volutpat arcu dapibus. </p>
                    </div>
                </a>
